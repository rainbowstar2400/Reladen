...
export function DeskPanel({ children, className = '', contentClassName = '' }: DeskPanelProps) {
  ...
  return (
    <section
      className={
        'min-h-[70vh] h-[min(78vh,860px)] overflow-hidden rounded-[28px] border border-white/30 bg-white/14 text-white/90 shadow-[0_18px_40px_rgba(6,18,32,0.22)] backdrop-blur-md ' +
